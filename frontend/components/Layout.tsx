      ...
      <aside className="w-72 bg-black text-white flex flex-col hidden md:flex">
        ...
        <nav className="flex-1 mt-8 px-4 space-y-2">
          ...
          <button 
            ...
            onMouseEnter={() => onPreloadCalendar?.()}
            className={`w-full flex items-center px-5 py-4 rounded-2xl transition-all text-[10px] font-black uppercase tracking-widest ${currentView === 'calendar' ? 'bg-orange-500 text-white shadow-lg shadow-orange-900/20' : 'hover:bg-zinc-900 text-slate-400'}`}
          >
